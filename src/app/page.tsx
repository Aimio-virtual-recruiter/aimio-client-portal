...
const en = {
  ...
  pricing: {
    ...
    subtitle: "A fraction of the cost of an internal recruiter or recruitment agency. 30-day money-back guarantee.",
    popular: "Most popular",
    mo: "mo",
    cta: "Book a demo",
    note: "Choose your commitment: 3, 6 or 12 months. Save up to 20% with longer terms. 30-day money-back guarantee on first month.",
  ...
  guarantee: {
    ...
    points: [
      ...
      "Flexible commitment: 3, 6 or 12 months — choose what fits",
...
const fr = {
  ...
  pricing: {
    ...
    subtitle: "Une fraction du co\u00fbt d\u2019un recruteur interne ou d\u2019une agence. Garantie de remboursement 30 jours.",
    popular: "Le plus populaire",
    mo: "mois",
    cta: "R\u00e9server une d\u00e9mo",
    note: "Choisissez votre engagement : 3, 6 ou 12 mois. \u00c9pargnez jusqu'\u00e0 20% avec un engagement plus long. Garantie de remboursement 30 jours sur le premier mois.",
  ...
  guarantee: {
    ...
    points: [
      ...
      "Engagement flexible : 3, 6 ou 12 mois selon vos besoins",
