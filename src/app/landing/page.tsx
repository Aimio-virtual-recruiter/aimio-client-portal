...
const en = {
  ...
  pricing: {
    ...
    subtitle: "Predictable monthly fee. No hidden costs. 30-day money-back guarantee.",
    popular: "Most popular",
    mo: "mo",
    cta: "Book a demo",
    note: "Choose your commitment: 3, 6 or 12 months. Save up to 20% with longer terms. 30-day money-back guarantee.",
...
const fr = {
  ...
  pricing: {
    ...
    subtitle: "Forfait mensuel pr\u00e9visible. Aucun frais cach\u00e9. Garantie de remboursement 30 jours.",
    popular: "Le plus populaire",
    mo: "mois",
    cta: "R\u00e9server une d\u00e9mo",
    note: "Choisissez votre engagement : 3, 6 ou 12 mois. \u00c9pargnez jusqu'\u00e0 20% avec un engagement plus long. Garantie de remboursement 30 jours.",
